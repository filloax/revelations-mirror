return {
    ...
    POST_SPAWN_CUSTOM_DOOR = "POST_SPAWN_CUSTOM_DOOR", -- (door, data, sprite, doorData, customGrid, force, respawning)
    POST_CUSTOM_DOOR_UPDATE = "POST_CUSTOM_DOOR_UPDATE", -- (door, data, sprite, doorData, persistData)
