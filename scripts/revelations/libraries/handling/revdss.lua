local DSSInitializerFunction = include("scripts.revelations.libraries.sources.dssmenucore")
...
local Credits = include("scripts.revelations.libraries.handling.revdss.credits")
local UnlockMenu = include("scripts.revelations.libraries.handling.revdss.unlockmenu")
local BossMenu = include("scripts.revelations.libraries.handling.revdss.bosshall")
...
include("scripts.revelations.libraries.handling.revdss.changelogs")
