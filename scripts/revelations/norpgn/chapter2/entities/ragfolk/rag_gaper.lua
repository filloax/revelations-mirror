...
local function ragGaperUpdate(_, npc)
    ...
    if data.Buffed and not data.BuffedInit then
        sprite:ReplaceSpritesheet(1, "gfx/monsters/revel2/rag_gaper/rag_gaper_body_buffed.png")
        sprite:ReplaceSpritesheet(2, "gfx/monsters/revel2/rag_gusher/rag_gusher_buffed.png")
        sprite:ReplaceSpritesheet(3, "gfx/monsters/revel2/rag_gusher/rag_gusher_buffed.png")
        sprite:LoadGraphics()
    ...
    elseif data.State == "Gaper Trip" then
        ...
        if sprite:IsEventTriggered("Spawn") then
            ...
            REVEL.GetData(head).Buffed = data.Buffed
        end
