...
return function()
    ...
    REVEL.STAGE.Glacier:SetTransitionMusic(REVEL.MUSIC.TRANSITION)
    REVEL.STAGE.Glacier:SetStageMusic(REVEL.MUSIC.GLACIER)
    REVEL.STAGE.Glacier:SetMusic(REVEL.MUSIC.GLACIER, {RevRoomType.CHILL})
    REVEL.STAGE.Glacier:SetChallengeMusic(REVEL.MUSIC.CHALLENGE, REVEL.MUSIC.BOSS_CALM, nil, REVEL.MUSIC.CHALLENGE_END)
    REVEL.STAGE.Glacier:SetBossMusic(REVEL.MUSIC.GLACIER_BOSS, REVEL.MUSIC.BOSS_CALM, REVEL.MUSIC.GLACIER_BOSS_INTRO, REVEL.MUSIC.GLACIER_BOSS_OUTRO)
