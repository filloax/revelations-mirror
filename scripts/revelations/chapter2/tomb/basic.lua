...
REVEL.STAGE.Tomb:SetTransitionMusic(REVEL.MUSIC.TRANSITION)
REVEL.STAGE.Tomb:SetStageMusic(REVEL.MUSIC.TOMB)
REVEL.STAGE.Tomb:SetMusic(REVEL.MUSIC.TOMB, {RevRoomType.TRAP})
REVEL.STAGE.Tomb:SetBossMusic(REVEL.MUSIC.TOMB_BOSS, REVEL.MUSIC.BOSS_CALM, REVEL.MUSIC.TOMB_BOSS_INTRO, REVEL.MUSIC.TOMB_BOSS_OUTRO)
REVEL.STAGE.Tomb:SetChallengeMusic(REVEL.MUSIC.CHALLENGE, REVEL.MUSIC.BOSS_CALM, nil, REVEL.MUSIC.CHALLENGE_END)
